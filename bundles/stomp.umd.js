(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["StompJs"] = factory();
  else root["StompJs"] = factory();
        ...
        /***/ function(module, exports, __webpack_require__) {
          ...
          var Client = /** @class */ (function() {
                ...
                return __generator(this, function(_a) {
                  switch (_a.label) {
                    ...
                    case 1:
                      ...
                      this._stompHandler = new stomp_handler_1.StompHandler(
                        this,
                        this._webSocket,
                        {
                          debug: this.debug,
            ...
            Client.prototype.subscribe = function(
              ...
              return this._stompHandler.subscribe(
                destination,
                callback,
                headers
              );
             ...
             * ```
             */
            Client.prototype.nack = function(
              messageId,
              subscriptionId,
              headers
            ) {
  ...
  \********************************************/
        ...
        /***/ function(module, exports, __webpack_require__) {
          ...
          var CompatClient = /** @class */ (function(_super) {
             ...
             * To upgrade, please follow the [Upgrade Guide](../additional-documentation/upgrading.html)
             */
            CompatClient.prototype.disconnect = function(
              disconnectCallback,
              headers
            ) {
              if (headers === void 0) {
        ...
        /***/ function(module, exports, __webpack_require__) {
          ...
          var FrameImpl = /** @class */ (function() {
            ...
            FrameImpl.fromRawFrame = function(rawFrame, escapeHeaderValues) {
              ...
              for (
                var _i = 0, _a = rawFrame.headers.reverse();
                _i < _a.length;
                _i++
              ) {
                var header = _a[_i];
            ...
            FrameImpl.prototype.serialize = function() {
              ...
              if (this.isBinaryBody) {
                return FrameImpl.toUnit8Array(cmdAndHeaders, this._binaryBody)
                  .buffer;
              } else {
            ...
            FrameImpl.prototype.serializeCmdAndHeaders = function() {
              ...
              for (
                var _i = 0, _a = Object.keys(this.headers || {});
                _i < _a.length;
                _i++
              ) {
                var name_1 = _a[_i];
                ...
                if (
                  ...
                  lines.push(
                    name_1 + ":" + FrameImpl.hdrValueEscape("" + value)
                  );
                } else {
              ...
              return (
                lines.join(byte_1.BYTE.LF) + byte_1.BYTE.LF + byte_1.BYTE.LF
              );
            };
            ...
            FrameImpl.toUnit8Array = function(cmdAndHeaders, binaryBody) {
              ...
              var uint8Frame = new Uint8Array(
                uint8CmdAndHeaders.length +
                  binaryBody.length +
  ...
  \**********************/
        ...
        /***/ function(module, exports, __webpack_require__) {
          ...
          __export(
            __webpack_require__(/*! ./frame-impl */ "./src/frame-impl.ts")
          );
          __export(__webpack_require__(/*! ./parser */ "./src/parser.ts"));
          __export(
            __webpack_require__(/*! ./stomp-config */ "./src/stomp-config.ts")
          );
          __export(
            __webpack_require__(/*! ./stomp-headers */ "./src/stomp-headers.ts")
          );
          __export(
            __webpack_require__(
        ...
        /***/ function(module, exports, __webpack_require__) {
          ...
          var Parser = /** @class */ (function() {
            ...
            Parser.prototype._setupCollectBody = function() {
              var contentLengthHeader = this._results.headers.filter(function(
                header
              ) {
          ...
          var StompHandler = /** @class */ (function() {
            function StompHandler(_client, _webSocket, config) {
              ...
              this._serverFrameHandlers = {
                ...
                MESSAGE: function(frame) {
                  ...
                  var onReceive =
                    _this._subscriptions[subscription] ||
                    _this.onUnhandledMessage;
                  // bless the frame to be a Message
                  var message = frame;
                  var client = _this;
                  var messageId =
                    _this._connectedVersion === versions_1.Versions.V1_2
                      ? message.headers.ack
                ...
                RECEIPT: function(frame) {
                  var callback =
                    _this._receiptWatchers[frame.headers["receipt-id"]];
                  if (callback) {
                    callback(frame);
            ...
            StompHandler.prototype.start = function() {
              ...
              var parser = new parser_1.Parser(
                // On Frame
                function(rawFrame) {
                  var frame = frame_impl_1.FrameImpl.fromRawFrame(
                    rawFrame,
                    _this._escapeHeaderValues
                  );
                  // if this.logRawCommunication is set, the rawChunk is logged at this._webSocket.onmessage
                  if (!_this.logRawCommunication) {
                    _this.debug("<<< " + frame);
                  }
                  var serverFrameHandler =
                    _this._serverFrameHandlers[frame.command] ||
                    _this.onUnhandledFrame;
              ...
              this._webSocket.onopen = function() {
                ...
                connectHeaders[
                  "accept-version"
                ] = _this.stompVersions.supportedVersions();
            ...
            StompHandler.prototype._setupHeartbeat = function(headers) {
              var _this = this;
              if (
                headers.version !== versions_1.Versions.V1_1 &&
            ...
            StompHandler.prototype.dispose = function() {
              ...
              if (this.connected) {
                try {
                  // clone before updating
                  var disconnectHeaders = Object.assign(
                    {},
                  ...
                  this.watchForReceipt(disconnectHeaders.receipt, function(
                    frame
                  ) {
                    _this._webSocket.close();
                    _this._cleanUp();
            ...
            StompHandler.prototype.watchForReceipt = function(
              receiptId,
              callback
            ) {
              this._receiptWatchers[receiptId] = callback;
            };
            StompHandler.prototype.subscribe = function(
              destination,
              callback,
              headers
            ) {
            ...
            StompHandler.prototype.ack = function(
              messageId,
              subscriptionId,
              headers
            ) {
            ...
            StompHandler.prototype.nack = function(
              messageId,
              subscriptionId,
              headers
            ) {
  ...
  \****************************/
        ...
        /***/ function(module, exports, __webpack_require__) {
          module.exports = __webpack_require__(
            /*! /Users/kdeepak/MyWork/Tech/stomp/stompjs/src/index.ts */ "./src/index.ts"
          );
